...
import { IconFolderPlus, IconX, IconFileDescription, IconCalendar } from '@tabler/icons-react';
    ...
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-gray-900 w-full max-w-md rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            <label className="flex text-xs font-black uppercase tracking-widest text-gray-400 mb-2  items-center gap-1">
